...
begin
  Back := TForm.Create(Form1);

  try
    Back.Position := poOwnerFormCenter;
      Back.BoundsRect := Form1.GetClientRect;
      Back.ClientHeight := Self.FClientHeight;
   ...
   Back.SetBounds(Form1.Left, Form1.Top-10, Back.Width, Back.Height);
